<?php if(!class_exists('Rain\Tpl')){exit;}?><form method="post" action="https://sandbox.pagseguro.uol.com.br/v2/checkout/payment.html">  
          
        <!-- Campos obrigatórios -->  
        <input name="receiverEmail" type="hidden" value="smfabio@gmail.com">  
